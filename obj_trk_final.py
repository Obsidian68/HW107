...
def drawBox(img,bbox):
    ...
    cv2.putText(img,'Tracking...',(200,200),cv2.FONT_HERSHEY_COMPLEX,0.7,(255,255,255),2)
...
while True:
   #Write the code inside loop here
    ...
    if success:
        ...
        cv2.putText(img,'The Object Is Lost',(200,200),cv2.FONT_HERSHEY_COMPLEX,0.7,(255,255,255),2)        
